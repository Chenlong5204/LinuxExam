...
public class UpdateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://121.37.171.159/LinuxExam";
    final static String USER = "root";
    final static String PASS = "Chenlong520#";
    final static String SQL_INSERT_NOTEPAD = "UPDATE  t_Notepad SET notepadName=? WHERE id=?";
